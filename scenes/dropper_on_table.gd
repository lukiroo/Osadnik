...
## =========================================================================
## dropper_on_table.gd – dropper leżący na stole
## -------------------------------------------------------------------------
## Odpowiada za:
## - emitowanie sygnału left_clicked po kliknięciu LPM,
## - proste podświetlenie przy najechaniu kursorem,
## - duplikację materiału shadera, żeby highlight był per instancja.
## =========================================================================
...
## Obsługuje kliknięcie LPM na dropperze – emituje left_clicked(dropper).
...
## Reaguje na wejście kursora – włącza outline, jeśli hover jest aktywny i LPM nie jest wciśnięty.
...
## Globalnie reaguje na klik LPM – gasi outline, żeby nie „zaczepiał się” przy dragowaniu.
...
## Włącza lub wyłącza podświetlenie droppera z poziomu Lab.
...
## Bezpiecznie ustawia uniform w shaderze, tylko jeśli shader faktycznie go definiuje.
